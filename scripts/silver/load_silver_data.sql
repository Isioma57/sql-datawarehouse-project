...
===============================================================================
Script Purpose:
    - Populate the silver schema from bronze
    - Truncate + insert into silver 
...
BEGIN
    ...
    SELECT
        ...
        END,
        prd_start_dt::DATE,
        (LEAD(prd_start_dt) OVER (PARTITION BY SUBSTRING(prd_key,7) ORDER BY prd_start_dt) - INTERVAL '1 day')::DATE
